...
_PERMISSION_METADATA_BY_TOOL_NAME = {
    ...
    "list_foreshadowings": ToolPermissionMetadata("list_foreshadowings", "allow"),
    ...
    "record_foreshadowing": ToolPermissionMetadata("record_foreshadowing", "ask"),
    ...
    "resolve_foreshadowing": ToolPermissionMetadata("resolve_foreshadowing", "ask"),
